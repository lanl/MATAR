...
int main(int argc, char* argv[]) {
    ...
    {  // MATAR scope
        ...
        FOR_FIRST(tile_idx, 0, num_tiles * num_tiles, {
            ...
            int i_end = (i_start + TILE_SIZE < MATRIX_SIZE) ? i_start + TILE_SIZE : MATRIX_SIZE;
            int j_end = (j_start + TILE_SIZE < MATRIX_SIZE) ? j_start + TILE_SIZE : MATRIX_SIZE;
            ...
            FOR_SECOND(local_i, 0, i_end - i_start, {
                ...
                for (int j = j_start; j < j_end; j++) {
                    ...
                    for (int k_tile = 0; k_tile < MATRIX_SIZE; k_tile += TILE_SIZE) {
                        ...
                        int k_end = (k_tile + TILE_SIZE < MATRIX_SIZE) ? k_tile + TILE_SIZE : MATRIX_SIZE;
