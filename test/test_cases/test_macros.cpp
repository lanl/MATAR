...
inline void run_for_all_fill(CArrayKokkos<int>& arr1, CArrayKokkos<int>& arr2, CArrayKokkos<int>& arr3) {
    FOR_ALL(i, 0, N0, {
        arr1(i) = i;
    });
    FOR_ALL(i, 0, N0, {
...
inline void run_do_all_fill(FArrayKokkos<int>& arr1, FArrayKokkos<int>& arr2, FArrayKokkos<int>& arr3) {
    DO_ALL(i, 0, N0 - 1, {
        arr1(i) = i;
    });
    DO_ALL(i, 0, N0 - 1, {
...
inline void hierarchical_reduce_second(CArrayKokkos<int>& arr1, const CArrayKokkos<int>& arr3) {
    FOR_FIRST(i, 0, NH, {
        int loc_sum = 0;
        int result  = 0;
        FOR_REDUCE_SUM_SECOND(j, i, NH,
                              loc_sum, {
            loc_sum += arr3(i, j, 0);
        }, result);
        arr1(i) = result;
...
public:
    ...
    MacroClassHarness() : arr1_(N0), arr2_(N0, N1), arr3_(N0, N1, N2), run_flag_(1) {}

    void fill_with_for_all_class() {
        FOR_ALL_CLASS(i, 0, N0, {
            arr1_(i) = i;
        });
        FOR_ALL_CLASS(i, 0, N0,
                      j, 0, N1, {
