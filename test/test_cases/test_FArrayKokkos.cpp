...
TEST(Test_FArrayKokkos, names) {
    std::vector<int> sizes;
    std::vector<std::string> names = {"A_1D_FArrayKokkos",
                                      "A_2D_FArrayKokkos",
                                      "A_3D_FArrayKokkos",
                                      "A_4D_FArrayKokkos",
                                      "A_5D_FArrayKokkos",
...
TEST(Test_FArrayKokkos, operator_access) {
    ...
    A1.set_values(42.0);
    {
        auto m = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace{}, A1.get_kokkos_view());
        EXPECT_EQ(m(5), 42.0);
    }
    ...
    A2.set_values(42.0);
    {
        auto m = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace{}, A2.get_kokkos_view());
        EXPECT_EQ(m(0), 42.0);
    }
    ...
    A3.set_values(42.0);
    {
        auto m = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace{}, A3.get_kokkos_view());
        EXPECT_EQ(m(0), 42.0);
    }
    ...
    A4.set_values(42.0);
    {
        auto m = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace{}, A4.get_kokkos_view());
        EXPECT_EQ(m(0), 42.0);
    }
    ...
    A5.set_values(42.0);
    {
        auto m = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace{}, A5.get_kokkos_view());
        EXPECT_EQ(m(0), 42.0);
    }
    ...
    A6.set_values(42.0);
    {
        auto m = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace{}, A6.get_kokkos_view());
        EXPECT_EQ(m(0), 42.0);
    }
    ...
    A7.set_values(42.0);
    {
        auto m = Kokkos::create_mirror_view_and_copy(Kokkos::HostSpace{}, A7.get_kokkos_view());
        EXPECT_EQ(m(0), 42.0);
    }
}
...
void fill_view_scalar(ViewType view, int n, double val) {
    Kokkos::parallel_for("FillViewScalar", n, KOKKOS_LAMBDA(const int i) { view(i) = val; });
}
}  // namespace
